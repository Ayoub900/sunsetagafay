            ...
            <div style={cardStyle}>
              <form id="block-form" action={editing ? updateWithId! : createBlock}>
                <FormSection title="Service">
                  <Field label="What to close" full hint="Pick one item, all of a type, or the entire property. Only suites are auto-blocked on the site; other services are inquiry-only, so their blocks are recorded here for staff.">
