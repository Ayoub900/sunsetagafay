...
const columns: Column<SuiteRow>[] = [
  ...
  {
    key: 'plate', label: 'Plate', w: '80px',
    render: r => <span style={{ fontFamily: 'var(--mono, monospace)', fontSize: 12.5, color: T.ink3 }}>{r.plate}</span>,
  },
...
export function SuitesTable({ rows, deleteAction }: Props) {
  ...
  return (
    <AdminTable<SuiteRow>
      ...
      filterKey="status"
      searchKeys={['nameEn', 'nameFr', 'plate', 'view']}
