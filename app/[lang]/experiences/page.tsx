...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: '/og/experiences.jpg', width: 1200, height: 630, alt: 'Experiences — Sunset Agafay' }],
    },
    other: {
      ...
      <section style={{ background: 'var(--paper-deep)', padding: 'clamp(64px,9vw,120px) var(--gutter)' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 'var(--max-w)', margin: '0 auto' }}>
          <div className="hammam-grid">
            ...
            <div className="hammam-frame frame-double" style={{ width: '100%', aspectRatio: '3 / 5', position: 'relative' }}>
